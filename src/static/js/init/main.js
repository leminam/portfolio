...
function typeChanged() {
  ...
  Array.prototype.forEach.call(document.getElementsByClassName('JS-View-Type'), function(elem) {
    if (!elem.classList.contains("JS-Viewer-Ready")) {
      const elParams = GLOBAL.parseData(elem.dataset.viewerParams);
      const params = Object.assign({}, common, elParams);
...
function imageChanged() {
  ...
  Array.prototype.forEach.call(document.getElementsByClassName('JS-View-Image'), function(elem) {
    if (!elem.classList.contains("JS-Viewer-Ready")) {
      const elParams = GLOBAL.parseData(elem.dataset.viewerParams);
      const params = Object.assign({}, common, elParams);
